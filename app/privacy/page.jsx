  ...
  return (
    <div className="container mx-auto px-4 py-32">
      ...
      <div className="prose max-w-none">
        ...
        <p>
          We collect information that you provide directly to us when using the
          Zeal app, including but not limited to:
        </p>
        <ul>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to Zeal, the software program
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Zeal.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Zeal, accessible from{" "}
              <a
                href="zeal.rw"
        ...
        <ul>
          <li>
            <p>By email: hello@jwcart.org</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="zeal.rw/privacy"
                rel="external nofollow noopener"
                target="_blank"
              >
                zeal.rw/privacy
